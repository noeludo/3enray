$(document).ready(function() {
    ...
    function resetGame() {
        ...
        currentPlayer = playerXName; // Establecer el jugador actual como jugador X
        $("#currentPlayerIndicator").text(currentPlayer); // Mostrar el nombre del jugador X en el indicador de turno
        cells.click(cellClickHandler); // Volver a asignar el manejador de clic a todas las celdas
    }
    ...
    function checkWinner() {
        ...
        for (var i = 0; i < winningCombinations.length; i++) {
            ...
            if (cell1 !== "" && cell1 === cell2 && cell1 === cell3) {
                var winnerName = currentPlayer === playerXName ? playerXName : playerOName;
    ...
    function cellClickHandler() {
        if ($(this).text() === "") { // Verificar si la celda está vacía
            $(this).text(currentPlayer); // Colocar el nombre del jugador actual en la celda
            ...
            if (winner) {
                ...
                $("#currentPlayerIndicator").text(currentPlayer); // Actualizar el indicador de turno con el nombre del siguiente jugador
            }
        }
    }
